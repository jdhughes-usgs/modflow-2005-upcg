...
Cdep      IF(LKARR1(I,J,K).NE.0) LID = LKARR1(I,J,K)
      ...
      ILAKE(4,M) = LID
      ILAKE(5,M) = 6
CJDH      BEDLAK(M) = BDLKN1(I,J,K-1)
      BEDLAK(M) = 0.0  !JDH
      IF(K.GT.1) BEDLAK(M) = BDLKN1(I,J,K-1)  !JDH
...
5     FORMAT(5I10,10X,G10.5)  !JDH CHANGED F10.5 TO G10.5
