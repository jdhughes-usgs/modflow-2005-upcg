      MODULE GLOBAL
        ...
        INTEGER, SAVE,    DIMENSION(:,:,:), POINTER ::IACTCELL
      ...
      TYPE GLOBALTYPE
        ...
        INTEGER,    DIMENSION(:,:,:), POINTER ::IACTCELL
...
C     ------------------------------------------------------------------
     ...
     4                     BOTM,HOLD,IBOUND,IACTCELL,
     5                     CR,CC,CV,HCOF,RHS,BUFF,STRT,DDREF
...
C6------Allocate space for global arrays except discretization data.
      ...
      ALLOCATE (IACTCELL(NCOL,NROW,NLAY))
...
C
        ...
        DEALLOCATE(GLOBALDAT(IGRID)%IACTCELL)
