...
Source code for MODFLOW--2005 with the UPCG solver is available in the src subdirectory. A Microsoft Visual Studio solution and associate fortran, C++, and cu projects are available in the root directory.
